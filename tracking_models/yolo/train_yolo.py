...
def get_jersey_color_class(img_pil, box):
    ...
    if (mean_h < 15) or (mean_h > 165): return 3 # Red
    if (95 < mean_h < 135): return 4 # Blue
    if (20 < mean_h < 40): return 5 # Yellow
    if (40 < mean_h < 85): return 6 # Green
    ...
    for seq_path in tqdm(sequences):
        ...
        with fs.open(gt_path, "rb") as f:
            df = pd.read_csv(f, header=None, names=[
                ...
                "conf", "class_id", "visibility", "unused"
            ])
