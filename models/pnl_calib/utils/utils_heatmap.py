...
def generate_gaussian_array_vectorized(num_matrices, keypoints, original_size, down_ratio=2, sigma=2, proj_err_th=5.0):
    ...
    matrices = [
        generate_gaussian_matrix_vectorized(new_size[0], new_size[1], px, py, sigma) for px, py in center_points
    ]
...
def generate_gaussian_array_vectorized_l(num_matrices, keypoints, original_size, down_ratio=2, sigma=2, sigma_mult=1):
    ...
    matrices1 = [
        generate_gaussian_matrix_vectorized(new_size[0], new_size[1], px, py, sigma_f(px, py, new_size, sigma))
...
def generate_gaussian_array_vectorized_dist_l(
    num_matrices,
    keypoints,
    lines_aux,
    original_size,
